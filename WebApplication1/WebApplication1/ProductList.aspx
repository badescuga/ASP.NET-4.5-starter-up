...
AutoEventWireup="true"  
         CodeBehind="ProductList.aspx.cs" Inherits="WebApplication1.ProductList" %> 
    ...
    <section> 
        <div> 
            ...
            <asp:ListView ID="productList" runat="server"  
                ...
                ItemType="WebApplication1.Models.Product" SelectMethod="GetProducts"> 
                <EmptyDataTemplate> 
                    <table > 
                        <tr> 
...
href="ProductDetails.aspx?productID=<%#:Item.ProductID%>"> 
                                        <img src="/Catalog/Images/Thumbs/<%#:Item.ImagePath%>"                                             width="100" height="75" style="border: 
solid" /></a> 
                                </td> 
                            </tr> 
                            <tr> 
